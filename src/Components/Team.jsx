...
const Team= () => {
    ...
    return (
      <div name='Team' className="w-full h-max  bg-black  ">
        <div>
        <h1 className=" font-display text-zinc-300 text-center pt-20  text-3xl font-extrabold leading-none tracking-tight md:text-5xl  lg:text-8xl lg:mb-12">
       Team
      </h1>
        </div>
        <div>
          <h1 className='text-white pl-28 pt-10 pb-10 sm:pb-0 sm:pt-0 sm:pl-36  text-3xl mb-10 font-semibold'>Core Members</h1>
        </div>
        <div className='flex  flex-col sm:flex-row justify-center items-center gap-12'>
        <div
          className="flip-card w-[250px] h-[400px] rounded-md perspective"
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.6, type: 'spring', stiffness: 500, damping: 50 }}
      ...
      <div>
          <h1 className='text-white  pl-36  text-3xl mt-20 mb-10 font-semibold'>Leads</h1>
        </div>
      ...
      <div>
          <h1 className='text-white  pl-36  text-3xl mt-20 mb-10 font-semibold'>Co-Leads</h1>
        </div>

      <div className='flex  flex-col sm:flex-row justify-center pb-36 items-center gap-12'>
        <div>
